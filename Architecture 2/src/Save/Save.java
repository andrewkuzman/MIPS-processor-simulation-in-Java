...
public class Save extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        imemInstrction.setBounds(170, 380, 70, 30);
        ...
        Mux2PC.setText(B.To_Hexa(add2Mux.getText()));
        getContentPane().add(Mux2PC);
        Mux2PC.setBounds(770, 60, 80, 30);
        ...
        rt2WriteData.setForeground(new java.awt.Color(255, 0, 0));
        rt2WriteData.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        rt2WriteData.setText("To Be Determined");
        getContentPane().add(rt2WriteData);
        rt2WriteData.setBounds(410, 410, 120, 30);
        ...
        mux2Alu.setForeground(new java.awt.Color(51, 51, 51));
        ...
        backGroundLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Save/save.JPG"))); // NOI18N
