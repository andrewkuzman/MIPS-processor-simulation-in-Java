...
public class Itype extends javax.swing.JFrame {

    private int no_ins;

    public Itype(int no_ins) {
        this.no_ins = no_ins;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        imemInstrction.setBounds(170, 380, 50, 30);
        ...
        mux2regfile.setText(i16to20.getText());
        ...
        AluControl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        AluControl.setText(aluOp[no_ins]);
        getContentPane().add(AluControl);
        ...
        jLabel58.setBounds(260, 50, 70, 20);
        ...
        Mux2PC.setText(mux2Mux.getText());
        getContentPane().add(Mux2PC);
        Mux2PC.setBounds(760, 60, 100, 30);
        ...
        add2Mux.setBounds(360, 60, 50, 20);
        ...
        signExt2ShiftLeft.setBounds(370, 460, 80, 20);

        mux2RegFile.setForeground(new java.awt.Color(255, 0, 0));
        mux2RegFile.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        mux2RegFile.setText("To Be Detrmined");
        getContentPane().add(mux2RegFile);
        mux2RegFile.setBounds(710, 370, 130, 40);
        ...
        AluCntrl2Alu.setText("To be decided");
        ...
        PC2Add.setText(pc2Imem.getText());
        getContentPane().add(PC2Add);
        PC2Add.setBounds(30, 300, 70, 20);
        ...
        mux2Alu.setText(signExt2ShiftLeft.getText());
        ...
        mux2Mux.setBounds(700, 90, 100, 20);

        backGroundLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Itype/Itype.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Itype.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
