...
public class DataPath extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        imemInstrction.setText(B.To_Hexa(B.R_Type_INSBINARY(no_ins)));
        getContentPane().add(imemInstrction);
        imemInstrction.setBounds(140, 380, 80, 30);
        ...
        mux2regfile.setText(B.To_Hexa(B.First_Reg_BINARY(no_ins)));
        ...
        i16to20.setText(B.To_Hexa(B.Third_Reg_BINARY(no_ins)));
        getContentPane().add(i16to20);
        i16to20.setBounds(200, 320, 100, 20);
        ...
        i26to31.setText(B.To_Hexa(B.Get_OPCode_R_Type(no_ins)));
        getContentPane().add(i26to31);
        i26to31.setBounds(140, 160, 120, 20);
        ...
        i21to25.setText(B.To_Hexa(B.Second_Reg_BINARY(no_ins)));
        getContentPane().add(i21to25);
        i21to25.setBounds(180, 300, 110, 20);
        ...
        Mux2PC.setText(B.To_Hexa(mux2Mux.getText()));
        getContentPane().add(Mux2PC);
        Mux2PC.setBounds(720, 60, 90, 30);
        ...
        add2Mux.setBounds(341, 60, 60, 20);
        ...
        AluCntrl2Alu.setText(B.To_Hexa(B.Get_Function_Code(no_ins)));
        ...
        i11to15.setText(B.To_Hexa(B.First_Reg_BINARY(no_ins)));
        ...
        i0to5.setText(B.To_Hexa(B.Get_Function_Code(no_ins)));
        ...
        mux2Alu.setText(rt.getText());
        getContentPane().add(mux2Alu);
        mux2Alu.setBounds(420, 350, 120, 30);

        mux2Mux.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        mux2Mux.setText(B.To_Hexa(add2Mux.getText()));
        getContentPane().add(mux2Mux);
        mux2Mux.setBounds(640, 90, 120, 20);

        backGroundLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/datapath/Rtype.jpg"))); // NOI18N
