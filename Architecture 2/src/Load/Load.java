...
public class Load extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        //Alu control signal don't change change
        AluControl = new javax.swing.JLabel();
        ...
        imemInstrction.setText(B.I_Type_INSBINARY(no_ins));
        getContentPane().add(imemInstrction);
        imemInstrction.setBounds(170, 380, 110, 30);
        ...
        i16to20.setText(B.First_Reg_BINARY(no_ins));
        getContentPane().add(i16to20);
        i16to20.setBounds(190, 320, 170, 20);
        ...
        i26to31.setText(B.Get_OPCode_I_Type(no_ins));
        ...
        i21to25.setText(B.Second_Reg_BINARY(no_ins));
        getContentPane().add(i21to25);
        i21to25.setBounds(200, 300, 120, 20);
        ...
        Mux2PC.setText(add2Mux.getText());
        getContentPane().add(Mux2PC);
        Mux2PC.setBounds(680, 10, 160, 30);

        add2Mux.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        add2Mux.setText(B.ADDRESS(no_ins+1)+"");
        getContentPane().add(add2Mux);
        add2Mux.setBounds(181, 60, 220, 20);

        signExt2ShiftLeft.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        signExt2ShiftLeft.setText(B.Real_Number_32_Bit(B.REAL_Number_BINARY(no_ins)));
        getContentPane().add(signExt2ShiftLeft);
        signExt2ShiftLeft.setBounds(370, 460, 40, 20);

        mux2RegFile.setForeground(new java.awt.Color(255, 0, 0));
        mux2RegFile.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        mux2RegFile.setText("To Be Determined");
        getContentPane().add(mux2RegFile);
        mux2RegFile.setBounds(710, 370, 110, 40);
        ...
        mux2Alu.setText(B.Real_Number_32_Bit(B.REAL_Number_BINARY(no_ins)));
        ...
        mux2Mux.setText(add2Mux.getText());
        getContentPane().add(mux2Mux);
        mux2Mux.setBounds(550, 90, 210, 20);

        backGroundLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Load/Load.jpg"))); // NOI18N
